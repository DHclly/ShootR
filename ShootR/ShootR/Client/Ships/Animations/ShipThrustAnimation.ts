...
module ShootR {
    ...
    export class ShipThrustAnimation extends eg.Graphics.Sprite2d {
        ...
        constructor(contentManager: eg.Content.ContentManager) {
            const thrustStartSpriteSheet = contentManager.GetImage("ThrustStart");
            const thrustSpriteSheet = contentManager.GetImage("Thrust");
            super(-Ship.SIZE.HalfWidth - ShipThrustAnimation.FRAME_SIZE.HalfWidth, 0,
                thrustSpriteSheet, ShipThrustAnimation.FRAME_SIZE.Width, ShipThrustAnimation.FRAME_SIZE.Height);
            this._thrustStartSpriteSheet = thrustStartSpriteSheet;

            this._thrustSpriteSheet = thrustSpriteSheet;
